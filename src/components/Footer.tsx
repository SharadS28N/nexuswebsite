        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors">Live Streaming</a></li>
              <li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors">Event Management</a></li>
              <li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors">IT Infrastructure</a></li>
              <li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors">Network Solutions</a></li>
              <li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors">Cybersecurity</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors">Our Team</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors">Disclaimer</a></li>
            </ul>
          </div>
        </div>
